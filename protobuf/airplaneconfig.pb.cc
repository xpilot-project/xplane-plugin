...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 15, 28, sizeof(::xpilot::AirplaneConfig)},
};
...
const char descriptor_table_protodef_airplaneconfig_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\024airplaneconfig.proto\022\006xpilot\"\216\005\n\016Airpl"
  "aneConfig\022\025\n\010callsign\030\001 \001(\tH\000\210\001\001\022@\n\006ligh"
  "ts\030\002 \001(\0132+.xpilot.AirplaneConfig.Airplan"
  "eConfigLightsH\001\210\001\001\022\026\n\tgear_down\030\003 \001(\010H\002\210"
  "\001\001\022\022\n\005flaps\030\004 \001(\002H\003\210\001\001\022\027\n\nengines_on\030\005 \001"
  "(\010H\004\210\001\001\022\036\n\021spoilers_deployed\030\006 \001(\010H\005\210\001\001\022"
  "\033\n\016reverse_thrust\030\007 \001(\010H\006\210\001\001\022\026\n\ton_groun"
  "d\030\010 \001(\010H\007\210\001\001\032\222\002\n\024AirplaneConfigLights\022\035\n"
  "\020strobe_lights_on\030\001 \001(\010H\000\210\001\001\022\036\n\021landing_"
  "lights_on\030\002 \001(\010H\001\210\001\001\022\033\n\016taxi_lights_on\030\003"
  " \001(\010H\002\210\001\001\022\035\n\020beacon_lights_on\030\004 \001(\010H\003\210\001\001"
  "\022\032\n\rnav_lights_on\030\005 \001(\010H\004\210\001\001B\023\n\021_strobe_"
  "lights_onB\024\n\022_landing_lights_onB\021\n\017_taxi"
  "_lights_onB\023\n\021_beacon_lights_onB\020\n\016_nav_"
  "lights_onB\013\n\t_callsignB\t\n\007_lightsB\014\n\n_ge"
  "ar_downB\010\n\006_flapsB\r\n\013_engines_onB\024\n\022_spo"
  "ilers_deployedB\021\n\017_reverse_thrustB\014\n\n_on"
  "_groundb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_airplaneconfig_2eproto = {
  false, false, 695, descriptor_table_protodef_airplaneconfig_2eproto, "airplaneconfig.proto", 
  ...
  if (_internal_has_lights()) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        2, _Internal::lights(this), target, stream);
  }

  // bool gear_down = 3;
  if (_internal_has_gear_down()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(3, this->_internal_gear_down(), target);
  }

  // float flaps = 4;
  if (_internal_has_flaps()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(4, this->_internal_flaps(), target);
  }

  // bool engines_on = 5;
  if (_internal_has_engines_on()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(5, this->_internal_engines_on(), target);
  }

  // bool spoilers_deployed = 6;
  if (_internal_has_spoilers_deployed()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(6, this->_internal_spoilers_deployed(), target);
  }

  // bool reverse_thrust = 7;
  if (_internal_has_reverse_thrust()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(7, this->_internal_reverse_thrust(), target);
  }

  // bool on_ground = 8;
  if (_internal_has_on_ground()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(8, this->_internal_on_ground(), target);
  }
