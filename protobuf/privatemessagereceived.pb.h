...
class PrivateMessageReceived final :
 ...
 public:
  ...
  ~PrivateMessageReceived() override;
...
void PrivateMessageReceived::set_from(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PrivateMessageReceived::set_message(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
