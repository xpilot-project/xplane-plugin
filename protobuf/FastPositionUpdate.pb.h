...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_FastPositionUpdate_2eproto_metadata_getter(int index);
namespace xpilot {
...
class FastPositionUpdate PROTOBUF_FINAL :
 ...
 public:
  ...
  inline FastPositionUpdate* New() const final {
    return CreateMaybeMessage<FastPositionUpdate>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_FastPositionUpdate_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
inline void FastPositionUpdate::set_callsign(const std::string& value) {
...
inline void FastPositionUpdate::set_callsign(std::string&& value) {
  _has_bits_[0] |= 0x00000001u;
  callsign_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:xpilot.FastPositionUpdate.callsign)
}
inline void FastPositionUpdate::set_callsign(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  callsign_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:xpilot.FastPositionUpdate.callsign)
}
inline void FastPositionUpdate::set_callsign(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  ...
  // @@protoc_insertion_point(field_set_pointer:xpilot.FastPositionUpdate.callsign)
}
