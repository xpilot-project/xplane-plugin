...
#include "PerformDisconnect.pb.h"
...
class Wrapper final :
 ...
 public:
  ...
  enum : int {
    ...
    kPluginMetadataFieldNumber = 19,
    kCslValidationFieldNumber = 20,
    kRequestStationInfoFieldNumber = 21,
    kPerformDisconnectFieldNumber = 22,
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::xpilot::XplaneData* release_xplane_data();
  ...
  // .xpilot.PluginMetadata plugin_metadata = 19;
  bool has_plugin_metadata() const;
  private:
  bool _internal_has_plugin_metadata() const;
  public:
  void clear_plugin_metadata();
  const ::xpilot::PluginMetadata& plugin_metadata() const;
  PROTOBUF_FUTURE_MUST_USE_RESULT ::xpilot::PluginMetadata* release_plugin_metadata();
  ::xpilot::PluginMetadata* mutable_plugin_metadata();
  void set_allocated_plugin_metadata(::xpilot::PluginMetadata* plugin_metadata);
  private:
  const ::xpilot::PluginMetadata& _internal_plugin_metadata() const;
  ::xpilot::PluginMetadata* _internal_mutable_plugin_metadata();
  public:
  void unsafe_arena_set_allocated_plugin_metadata(
      ::xpilot::PluginMetadata* plugin_metadata);
  ::xpilot::PluginMetadata* unsafe_arena_release_plugin_metadata();
  ...
  // .xpilot.PerformDisconnect perform_disconnect = 22;
  bool has_perform_disconnect() const;
  private:
  bool _internal_has_perform_disconnect() const;
  public:
  void clear_perform_disconnect();
  const ::xpilot::PerformDisconnect& perform_disconnect() const;
  PROTOBUF_FUTURE_MUST_USE_RESULT ::xpilot::PerformDisconnect* release_perform_disconnect();
  ::xpilot::PerformDisconnect* mutable_perform_disconnect();
  void set_allocated_perform_disconnect(::xpilot::PerformDisconnect* perform_disconnect);
  private:
  const ::xpilot::PerformDisconnect& _internal_perform_disconnect() const;
  ::xpilot::PerformDisconnect* _internal_mutable_perform_disconnect();
  public:
  void unsafe_arena_set_allocated_perform_disconnect(
      ::xpilot::PerformDisconnect* perform_disconnect);
  ::xpilot::PerformDisconnect* unsafe_arena_release_perform_disconnect();
...
inline ::xpilot::XplaneData* Wrapper::_internal_mutable_xplane_data() {
  if (!_internal_has_xplane_data()) {
    clear_msg();
    set_has_xplane_data();
    msg_.xplane_data_ = CreateMaybeMessage< ::xpilot::XplaneData >(GetArenaForAllocation());
  }
...
inline ::xpilot::PositionUpdate* Wrapper::_internal_mutable_position_update() {
  if (!_internal_has_position_update()) {
    clear_msg();
    set_has_position_update();
    msg_.position_update_ = CreateMaybeMessage< ::xpilot::PositionUpdate >(GetArenaForAllocation());
  }
...
inline ::xpilot::FastPositionUpdate* Wrapper::_internal_mutable_fast_position_update() {
  if (!_internal_has_fast_position_update()) {
    clear_msg();
    set_has_fast_position_update();
    msg_.fast_position_update_ = CreateMaybeMessage< ::xpilot::FastPositionUpdate >(GetArenaForAllocation());
  }
...
inline ::xpilot::AirplaneConfig* Wrapper::_internal_mutable_airplane_config() {
  if (!_internal_has_airplane_config()) {
    clear_msg();
    set_has_airplane_config();
    msg_.airplane_config_ = CreateMaybeMessage< ::xpilot::AirplaneConfig >(GetArenaForAllocation());
  }
...
inline ::xpilot::AddPlane* Wrapper::_internal_mutable_add_plane() {
  if (!_internal_has_add_plane()) {
    clear_msg();
    set_has_add_plane();
    msg_.add_plane_ = CreateMaybeMessage< ::xpilot::AddPlane >(GetArenaForAllocation());
  }
...
inline ::xpilot::PlaneAddedToSim* Wrapper::_internal_mutable_plane_added_to_sim() {
  if (!_internal_has_plane_added_to_sim()) {
    clear_msg();
    set_has_plane_added_to_sim();
    msg_.plane_added_to_sim_ = CreateMaybeMessage< ::xpilot::PlaneAddedToSim >(GetArenaForAllocation());
  }
...
inline ::xpilot::ChangePlaneModel* Wrapper::_internal_mutable_change_plane_model() {
  if (!_internal_has_change_plane_model()) {
    clear_msg();
    set_has_change_plane_model();
    msg_.change_plane_model_ = CreateMaybeMessage< ::xpilot::ChangePlaneModel >(GetArenaForAllocation());
  }
...
inline ::xpilot::DeletePlane* Wrapper::_internal_mutable_delete_plane() {
  if (!_internal_has_delete_plane()) {
    clear_msg();
    set_has_delete_plane();
    msg_.delete_plane_ = CreateMaybeMessage< ::xpilot::DeletePlane >(GetArenaForAllocation());
  }
...
inline ::xpilot::PrivateMessageReceived* Wrapper::_internal_mutable_private_message_received() {
  if (!_internal_has_private_message_received()) {
    clear_msg();
    set_has_private_message_received();
    msg_.private_message_received_ = CreateMaybeMessage< ::xpilot::PrivateMessageReceived >(GetArenaForAllocation());
  }
...
inline ::xpilot::PrivateMessageSent* Wrapper::_internal_mutable_private_message_sent() {
  if (!_internal_has_private_message_sent()) {
    clear_msg();
    set_has_private_message_sent();
    msg_.private_message_sent_ = CreateMaybeMessage< ::xpilot::PrivateMessageSent >(GetArenaForAllocation());
  }
...
inline ::xpilot::RadioMessageReceived* Wrapper::_internal_mutable_radio_message_received() {
  if (!_internal_has_radio_message_received()) {
    clear_msg();
    set_has_radio_message_received();
    msg_.radio_message_received_ = CreateMaybeMessage< ::xpilot::RadioMessageReceived >(GetArenaForAllocation());
  }
...
inline ::xpilot::RadioMessageSent* Wrapper::_internal_mutable_radio_message_sent() {
  if (!_internal_has_radio_message_sent()) {
    clear_msg();
    set_has_radio_message_sent();
    msg_.radio_message_sent_ = CreateMaybeMessage< ::xpilot::RadioMessageSent >(GetArenaForAllocation());
  }
...
inline ::xpilot::NetworkConnected* Wrapper::_internal_mutable_network_connected() {
  if (!_internal_has_network_connected()) {
    clear_msg();
    set_has_network_connected();
    msg_.network_connected_ = CreateMaybeMessage< ::xpilot::NetworkConnected >(GetArenaForAllocation());
  }
...
inline ::xpilot::NetworkDisconnected* Wrapper::_internal_mutable_network_disconnected() {
  if (!_internal_has_network_disconnected()) {
    clear_msg();
    set_has_network_disconnected();
    msg_.network_disconnected_ = CreateMaybeMessage< ::xpilot::NetworkDisconnected >(GetArenaForAllocation());
  }
...
inline ::xpilot::NearbyControllers* Wrapper::_internal_mutable_nearby_controllers() {
  if (!_internal_has_nearby_controllers()) {
    clear_msg();
    set_has_nearby_controllers();
    msg_.nearby_controllers_ = CreateMaybeMessage< ::xpilot::NearbyControllers >(GetArenaForAllocation());
  }
...
inline ::xpilot::SetTransponder* Wrapper::_internal_mutable_set_transponder() {
  if (!_internal_has_set_transponder()) {
    clear_msg();
    set_has_set_transponder();
    msg_.set_transponder_ = CreateMaybeMessage< ::xpilot::SetTransponder >(GetArenaForAllocation());
  }
...
inline ::xpilot::SetRadioStack* Wrapper::_internal_mutable_set_radiostack() {
  if (!_internal_has_set_radiostack()) {
    clear_msg();
    set_has_set_radiostack();
    msg_.set_radiostack_ = CreateMaybeMessage< ::xpilot::SetRadioStack >(GetArenaForAllocation());
  }
...
// .xpilot.PluginMetadata plugin_metadata = 19;
inline bool Wrapper::_internal_has_plugin_metadata() const {
  return msg_case() == kPluginMetadata;
}
inline bool Wrapper::has_plugin_metadata() const {
  return _internal_has_plugin_metadata();
}
inline void Wrapper::set_has_plugin_metadata() {
  _oneof_case_[0] = kPluginMetadata;
}
inline ::xpilot::PluginMetadata* Wrapper::release_plugin_metadata() {
  // @@protoc_insertion_point(field_release:xpilot.Wrapper.plugin_metadata)
  if (_internal_has_plugin_metadata()) {
    clear_has_msg();
      ::xpilot::PluginMetadata* temp = msg_.plugin_metadata_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    msg_.plugin_metadata_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::xpilot::PluginMetadata& Wrapper::_internal_plugin_metadata() const {
  return _internal_has_plugin_metadata()
      ? *msg_.plugin_metadata_
      : reinterpret_cast< ::xpilot::PluginMetadata&>(::xpilot::_PluginMetadata_default_instance_);
}
inline const ::xpilot::PluginMetadata& Wrapper::plugin_metadata() const {
  // @@protoc_insertion_point(field_get:xpilot.Wrapper.plugin_metadata)
  return _internal_plugin_metadata();
}
inline ::xpilot::PluginMetadata* Wrapper::unsafe_arena_release_plugin_metadata() {
  // @@protoc_insertion_point(field_unsafe_arena_release:xpilot.Wrapper.plugin_metadata)
  if (_internal_has_plugin_metadata()) {
    clear_has_msg();
    ::xpilot::PluginMetadata* temp = msg_.plugin_metadata_;
    msg_.plugin_metadata_ = nullptr;
...
inline void Wrapper::unsafe_arena_set_allocated_plugin_metadata(::xpilot::PluginMetadata* plugin_metadata) {
  clear_msg();
  if (plugin_metadata) {
    set_has_plugin_metadata();
    msg_.plugin_metadata_ = plugin_metadata;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:xpilot.Wrapper.plugin_metadata)
}
inline ::xpilot::PluginMetadata* Wrapper::_internal_mutable_plugin_metadata() {
  if (!_internal_has_plugin_metadata()) {
    clear_msg();
    set_has_plugin_metadata();
    msg_.plugin_metadata_ = CreateMaybeMessage< ::xpilot::PluginMetadata >(GetArenaForAllocation());
  }
  return msg_.plugin_metadata_;
}
inline ::xpilot::PluginMetadata* Wrapper::mutable_plugin_metadata() {
  // @@protoc_insertion_point(field_mutable:xpilot.Wrapper.plugin_metadata)
  return _internal_mutable_plugin_metadata();
}
...
inline ::xpilot::CslValidation* Wrapper::_internal_mutable_csl_validation() {
  if (!_internal_has_csl_validation()) {
    clear_msg();
    set_has_csl_validation();
    msg_.csl_validation_ = CreateMaybeMessage< ::xpilot::CslValidation >(GetArenaForAllocation());
  }
...
inline ::xpilot::RequestStationInfo* Wrapper::_internal_mutable_request_station_info() {
  if (!_internal_has_request_station_info()) {
    clear_msg();
    set_has_request_station_info();
    msg_.request_station_info_ = CreateMaybeMessage< ::xpilot::RequestStationInfo >(GetArenaForAllocation());
  }
...
// .xpilot.PerformDisconnect perform_disconnect = 22;
inline bool Wrapper::_internal_has_perform_disconnect() const {
  return msg_case() == kPerformDisconnect;
}
inline bool Wrapper::has_perform_disconnect() const {
  return _internal_has_perform_disconnect();
}
inline void Wrapper::set_has_perform_disconnect() {
  _oneof_case_[0] = kPerformDisconnect;
}
inline ::xpilot::PerformDisconnect* Wrapper::release_perform_disconnect() {
  // @@protoc_insertion_point(field_release:xpilot.Wrapper.perform_disconnect)
  if (_internal_has_perform_disconnect()) {
    clear_has_msg();
      ::xpilot::PerformDisconnect* temp = msg_.perform_disconnect_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    msg_.perform_disconnect_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::xpilot::PerformDisconnect& Wrapper::_internal_perform_disconnect() const {
  return _internal_has_perform_disconnect()
      ? *msg_.perform_disconnect_
      : reinterpret_cast< ::xpilot::PerformDisconnect&>(::xpilot::_PerformDisconnect_default_instance_);
}
inline const ::xpilot::PerformDisconnect& Wrapper::perform_disconnect() const {
  // @@protoc_insertion_point(field_get:xpilot.Wrapper.perform_disconnect)
  return _internal_perform_disconnect();
}
inline ::xpilot::PerformDisconnect* Wrapper::unsafe_arena_release_perform_disconnect() {
  // @@protoc_insertion_point(field_unsafe_arena_release:xpilot.Wrapper.perform_disconnect)
  if (_internal_has_perform_disconnect()) {
    clear_has_msg();
    ::xpilot::PerformDisconnect* temp = msg_.perform_disconnect_;
    msg_.perform_disconnect_ = nullptr;
...
inline void Wrapper::unsafe_arena_set_allocated_perform_disconnect(::xpilot::PerformDisconnect* perform_disconnect) {
  clear_msg();
  if (perform_disconnect) {
    set_has_perform_disconnect();
    msg_.perform_disconnect_ = perform_disconnect;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:xpilot.Wrapper.perform_disconnect)
}
inline ::xpilot::PerformDisconnect* Wrapper::_internal_mutable_perform_disconnect() {
  if (!_internal_has_perform_disconnect()) {
    clear_msg();
    set_has_perform_disconnect();
    msg_.perform_disconnect_ = CreateMaybeMessage< ::xpilot::PerformDisconnect >(GetArenaForAllocation());
  }
  return msg_.perform_disconnect_;
}
inline ::xpilot::PerformDisconnect* Wrapper::mutable_perform_disconnect() {
  // @@protoc_insertion_point(field_mutable:xpilot.Wrapper.perform_disconnect)
  return _internal_mutable_perform_disconnect();
}
...
inline ::xpilot::PlaneRemovedFromSim* Wrapper::_internal_mutable_plane_removed_from_sim() {
  if (!_internal_has_plane_removed_from_sim()) {
    clear_msg();
    set_has_plane_removed_from_sim();
    msg_.plane_removed_from_sim_ = CreateMaybeMessage< ::xpilot::PlaneRemovedFromSim >(GetArenaForAllocation());
  }
