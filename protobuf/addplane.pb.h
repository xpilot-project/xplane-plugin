...
class AddPlane_AircraftVisualState PROTOBUF_FINAL :
 ...
 public:
  ...
  virtual ~AddPlane_AircraftVisualState();
  ...
  inline AddPlane_AircraftVisualState* New() const final {
    return CreateMaybeMessage<AddPlane_AircraftVisualState>(nullptr);
  }
...
class AddPlane PROTOBUF_FINAL :
 ...
 public:
  ...
  ::xpilot::AddPlane_AircraftVisualState* release_visual_state();
...
inline ::xpilot::AddPlane_AircraftVisualState* AddPlane::_internal_mutable_visual_state() {
  ...
  if (visual_state_ == nullptr) {
    auto* p = CreateMaybeMessage<::xpilot::AddPlane_AircraftVisualState>(GetArena());
    visual_state_ = p;
  }
...
inline void AddPlane::set_allocated_visual_state(::xpilot::AddPlane_AircraftVisualState* visual_state) {
  ...
  if (visual_state) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(visual_state);
